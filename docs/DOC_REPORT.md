...
### 1. [MEDIUM] .env.example dosyası oluştur
- **WSJF Score:** 70
- **Rationale:** Environment variable'ları dokümante etmek önemli
- **Effort:** small


### 2. [LOW] CHANGELOG.md oluştur
- **WSJF Score:** 40
